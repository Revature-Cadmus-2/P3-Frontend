...
export class RootServiceService {
  ...
  private userUrl: string = "http://apollopost-prod.us-east-2.elasticbeanstalk.com/api/User";
  private groupUrl: string = "http://apollopost-prod.us-east-2.elasticbeanstalk.com/api/Group"
